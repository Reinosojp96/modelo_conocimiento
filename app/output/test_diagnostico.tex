...
\newpage
    ...
    \item simulaciones realistas y dinámicas de gamificación
\end{itemize}

    \subsubsection{Áreas de Mejora}
    \begin{itemize}
        \item limitaciones en la educación financiera en las escuelas colombianas
    \item falta de habilidades en gestión financiera en jóvenes
\end{itemize}

    \subsubsection{Recomendaciones}
    \begin{itemize}
        \item fortalecer la educación financiera en las escuelas
    \item desarrollar habilidades en gestión financiera en jóvenes
\end{itemize}
